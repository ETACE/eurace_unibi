...
*/
//       	NULL == CU_add_test(pSuite, "Eurostat_calculate_data", unittest_Eurostat_calculate_data)) // ||
...
//    	NULL == CU_add_test(pSuite, "Eurostat_calc_firm_population, adding", unittest1_Eurostat_calc_firm_population))// ||
//    	NULL == CU_add_test(pSuite, "Eurostat_calc_firm_population, copying", unittest2_Eurostat_calc_firm_population))// ||
    	NULL == CU_add_test(pSuite, "Eurostat_calc_firm_population, firm deaths", unittest3_Eurostat_calc_firm_population))// ||
